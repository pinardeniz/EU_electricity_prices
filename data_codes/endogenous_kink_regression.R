...
# Load in Data
library(readxl)
dataR <- read_excel("DATA_results_endo_kinkUN.xlsx", sheet = "SWE", range = "A25:J118") # A25
# FOR FIN : range = "A26:G118"
# FOR HUN: range = "A36:G118"
# FOR ITA: range = "A48:G118"
...
x = SEN
n = length(y)
z = cbind(IP,NG,RE,resid1,resid2,matrix(1,n,1))
#######################
